            ...
            <div class="row">
                <div class="col-12 mb-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="h2 mb-md-0 text-white fw-light">Project Report</h1>
                                    ...
                                    <div class="owl-item active" style="width: 251.4px; margin-right: 10px">
                                        <div class="item card bg-body">
                                            <div class="card-body">
                                                ...
                                                <h4>USD {{ number_format($totalProjectCost, 2) }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($projects as $project)
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge {{ $badge }}">{{ $project->projectStatus->name }}</span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
