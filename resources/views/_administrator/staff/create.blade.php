                                            ...
                                            <div class="modal-body custom_scroll">
                                                <ul class="nav nav-tabs tab-card px-0" role="tablist">
                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link active" href="add-user.html#step1"
                                                            data-bs-toggle="tab" data-bs-step="1">1. Personal
                                                            Information</a>
                                                    </li>
                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link" href="add-user.html#step2"
                                                            data-bs-toggle="tab" data-bs-step="2">2. Employment
                                                        </a>
                                                    </li>
                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link" href="add-user.html#step3"
                                                            data-bs-toggle="tab" data-bs-step="3">3. Education</a>
                                                    </li>
                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link" href="add-user.html#step4"
                                                            data-bs-toggle="tab" data-bs-step="4">4. Experience</a>
                                                    </li>
                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link" href="add-user.html#step5"
                                                            data-bs-toggle="tab" data-bs-step="5">5. Banking &
                                                            Compensation</a>
                                                    </li>
                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link" href="add-user.html#step6"
                                                            data-bs-toggle="tab" data-bs-step="6">6. IT & Security</a>
                                                    </li>

                                                    <li class="nav-item flex-fill text-center">
                                                        <a class="nav-link" href="add-user.html#step7"
                                                            data-bs-toggle="tab" data-bs-step="7">7. Review</a>
                                                    </li>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row g-2 mt-3">
                                                                    ...
                                                                    <div class="form-floating mb-2 col-12">
                                                                        ...
                                                                        <label class="form-label">Security Clearance
