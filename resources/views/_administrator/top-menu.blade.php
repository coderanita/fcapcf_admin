          ...
          <div class="dropdown-menu mega-dropdown p-4 shadow">
            <div class="row g-3">
              <div class="col-lg-7">
                <ul class="list-unstyled mb-0 animation_delay">
                  <li>
                    <a href="{{route('administrator.users')}}" class="d-flex align-items-center py-2 rounded">
                      <div class="avatar rounded no-thumbnail bg-light">
            ...
            <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button"
              ...
              @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                <img class="avatar lg img-thumbnail rounded-circle shadow"
                  src="{{ auth()->user()->profile_photo_url }}" alt="{{ auth()->user()->fullName() }}">
              @else
              ...
              <div class="card w240 overflow-hidden">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('logout') }}" x-data>
                    @csrf
                    <a class="btn bg-secondary text-light text-uppercase w-100" @click.prevent="$root.submit();">
