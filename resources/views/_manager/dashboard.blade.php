                        ...
                        <div class="ph-tab">
                            ...
                            <section>
                                ...
                                <div class="tab3 rounded-4">
                                    <div class="carousel vertical slide" data-bs-ride="carousel"
                                            ...
                                            <div class="carousel-item active">
                                                <div class="row g-2">
                                                    <div class="col-12">
                                                        <div
                                                            ...
                                                            <a class="text-decoration-underline text-secondary small"
                                                                href="projects.html">View</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <p class="small text-uppercase mb-2 text-muted">Pending
                                                                </p>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <p class="small text-uppercase mb-2 text-muted">
                                                                    Completed</p>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <p class="small text-uppercase mb-2 text-muted">In
                                                                    Progress</p>
                                                                <h5 class="mb-0">21</h5>
                                                            </div>
                                                        </div>
